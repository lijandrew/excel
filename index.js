...
function setupScrollAni() {
  gsap.to("#phone-svg", {opacity: 1, transform: "translate(0, -10%)", delay: 0.3, duration: 1, ease: "power1.out"});
  gsap.to("#reading-svg", {opacity: 1, transform: "translate(10%, 0)", delay: 0.3, duration: 1, ease: "power1.out"});
}
